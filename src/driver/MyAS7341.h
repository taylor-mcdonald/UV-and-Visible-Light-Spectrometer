...
#define AS7341_CFG8 0xB1 ///< AS7341_CFG8 (unused) Need to set bit 2 for auto gain comntrol of F1-F8.  Set bit 3 for Flicker auto gain control
#define AS7341_CFG9                                                            \
...
/**
 * @brief Operating modes for the AS7341
*/
typedef enum {
  SPM,
  SYNS,
...
public:
  ...
  bool setMode(as7341_mode mode);
  bool enableINTsel(bool enable_int_sel);
  ...
  bool getResults(AS7341Reading &measurment);
  ...
  bool enableWait(bool enable_wait);
  bool enableSpectralInterupt(bool enable_measurement);
  ...
  bool enableSpectralAutoGainControl(bool enable_int);
  bool enableFlickerAutoGainControl(bool enable_int);
